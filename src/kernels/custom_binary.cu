...
CUSTOM_BINARY_OP_OUT(__half, uint8_t, logical_or_f16, x || y )
#endif

#if __CUDA_ARCH__ >= 800
CUSTOM_BINARY_OP_OUT(__nv_bfloat16, uint8_t, logical_or_bf16, x || y )
#endif
...
CUSTOM_BINARY_OP_OUT(double, uint8_t, logical_or_f64, x || y )
